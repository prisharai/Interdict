...
The partial Opus numbers are lower than Haiku/Sonnet in the richer-feedback cells; \texttt{docs/START\_HERE.md} frames this as a capability nuance, not a confirmatory cross-model result.\footnote{Rate source: \texttt{docs/RESULTS\_STUDY.md} lines 37--43. Capability-nuance caveat source: \texttt{docs/START\_HERE.md} lines 58--61.}
...
The data state also limits inference. Haiku is complete and primary; Sonnet and Opus are partial because the sweep was interrupted by API credit limits. Additional caveats are a single provider family, 3 synthetic adversarial tasks, partial Sonnet/Opus cells, one seed, and v1 C3 confounding row-count feedback with confirmation framing.\footnote{These caveats are listed in \texttt{docs/START\_HERE.md}, lines 82--90.}
